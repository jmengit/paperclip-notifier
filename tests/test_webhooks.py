...
def event():
    return {
        ...
        "severity": "warning", "paperclip_url": "https://paperclip.example.com/PAP/approvals/a1",
...
def test_get_webhook_includes_encoded_link(event, monkeypatch):
    ...
    assert "paperclip_url=https%3A%2F%2Fpaperclip.example.com%2FPAP%2Fapprovals%2Fa1" in url
    assert body == b""
